...
auto_download(working_dir="C:/working_dir/", path_shp="C:/in_data/AOI_08.shp", start_year_elev=2009, end_year_elev=2023,
              start_year_ortho=2016, end_year_ortho=2019, dom=False, las=False, dgm=True, merge_dgm=False, merge_dom=False,
              merge_ortho=False, ortho=False)
